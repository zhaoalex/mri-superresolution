...
parser.add_argument('-s', '--scaling', type=str, default='2', help='Set scaling factor')
...
model = torch.load(os.path.join('models', args.model, 'best_model.pth'), map_location=lambda storage, loc: storage)
...
for img_path in imagelist:
    ...
    img = downscale(hr_gray, int(args.scaling))
